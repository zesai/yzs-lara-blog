...
@section('content')
  <div class="row">
    ...
    <div class="col-lg-9 col-md-9 col-sm-12 col-xs-12 topic-content">
      <div class="card ">
        ...
        <div class="card-profile clearfix">
          <div class="card-text float-left" style="border-right: 1px solid #444;width: 50%"><h5>上一篇</h5>
            <p class="card-text"><a href="">asdsadas</a></p>
          </div>
          <div class="card-text float-right" style="border-left: 1px solid #444;width: 50%">下一篇 </div>
        </div>
      </div>
    ...
    <div class="col-lg-3 col-md-3 hidden-sm hidden-xs author-info right-box">
